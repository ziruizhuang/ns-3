...
//    Ptr<NetDevice> dev = node->GetDevice (interface);
//    Ptr<NetDeviceQueueInterface> ndqi = dev->GetObject<NetDeviceQueueInterface> ();
//    ndi->second.m_rootQueueDisc
    oss4 << "/NodeList/" << node->GetId () << "/$ns3::TrafficControlLayer/RootQueueDiscList/" << interface << "/PacketsInQueue";
//    oss4 << "/NodeList/" << node->GetId () << "/$ns3::TrafficControlLayer/RootQueueDiscList/*/PacketsInQueue";
    Config::ConnectWithoutContextFailSafe (oss4.str (),
...
//    oss5 << "/NodeList/" << node->GetId () << "/$ns3::TrafficControlLayer/RootQueueDiscList/*/BytesInQueue";
    Config::ConnectWithoutContextFailSafe (oss5.str (),
